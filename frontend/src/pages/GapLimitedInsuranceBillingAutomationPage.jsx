...
// Gap (Non-AI): Limited insurance billing automation
// Limited insurance billing automation
import React, { useState } from 'react';

export default function GapLimitedInsuranceBillingAutomationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-insurance-billing-automation/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Limited insurance billing automation</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Limited insurance billing automation</p>
