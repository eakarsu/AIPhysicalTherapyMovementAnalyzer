...
// Custom Feature: Pain science education
// Pain science education: AI generates patient-specific pain science education videos based on diagnosis (e.g., if arthritis: explain cartilage, exercise benefits, realistic expectations)
import React, { useState } from 'react';

export default function CFPainScienceEducationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-pain-science-education/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Pain science education</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Pain science education: AI generates patient-specific pain science education videos based on diagnosis (e.g., if arthritis: explain cartilage, exercise benefits, realistic expectations)</p>
