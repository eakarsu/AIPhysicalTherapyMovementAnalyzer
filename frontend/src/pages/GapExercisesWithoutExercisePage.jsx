...
// Gap (AI): Exercises without '/exercise
// Exercises without /exercise-difficulty-adapt (adjust difficulty based on performance)
import React, { useState } from 'react';

export default function GapExercisesWithoutExercisePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-exercises-without-exercise/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Exercises without '/exercise</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Exercises without /exercise-difficulty-adapt (adjust difficulty based on performance)</p>
