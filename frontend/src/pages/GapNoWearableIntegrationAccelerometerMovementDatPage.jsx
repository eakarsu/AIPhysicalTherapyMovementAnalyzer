...
// Gap (Non-AI): No wearable integration (accelerometer movement data)
// No wearable integration (accelerometer movement data)
import React, { useState } from 'react';

export default function GapNoWearableIntegrationAccelerometerMovementDatPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-wearable-integration-accelerometer-movement-dat/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No wearable integration (accelerometer movement data)</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No wearable integration (accelerometer movement data)</p>
