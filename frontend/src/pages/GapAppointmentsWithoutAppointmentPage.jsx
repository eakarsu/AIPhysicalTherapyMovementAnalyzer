...
// Gap (AI): Appointments without '/appointment
// Appointments without /appointment-optimize (predict no-shows, suggest overbooking)
import React, { useState } from 'react';

export default function GapAppointmentsWithoutAppointmentPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-appointments-without-appointment/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Appointments without '/appointment</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Appointments without /appointment-optimize (predict no-shows, suggest overbooking)</p>
