...
// Custom Feature: Movement quality scoring
// Movement quality scoring: Computer vision rates movement against expected ROM/quality standards; tracks improvement over weeks; auto-generates progress reports with visual comparisons
import React, { useState } from 'react';

export default function CFMovementQualityScoringPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-movement-quality-scoring/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Movement quality scoring</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Movement quality scoring: Computer vision rates movement against expected ROM/quality standards; tracks improvement over weeks; auto-generates progress reports with visual comparisons</p>
