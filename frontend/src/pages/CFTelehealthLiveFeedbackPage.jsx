...
// Custom Feature: Telehealth live feedback
// Telehealth live feedback: Patient on video call; AI provides real-time correction (angle, speed, range); therapist focuses on coaching not form checking
import React, { useState } from 'react';

export default function CFTelehealthLiveFeedbackPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-telehealth-live-feedback/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Telehealth live feedback</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Telehealth live feedback: Patient on video call; AI provides real-time correction (angle, speed, range); therapist focuses on coaching not form checking</p>
