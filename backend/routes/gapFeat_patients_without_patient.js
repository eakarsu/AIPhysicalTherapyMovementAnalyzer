...
// Patients without /patient-dropout-predict (flag at-risk patients; suggest engagement)
...
async function callLLM(systemPrompt, userPrompt) {
  ...
  const res = await fetchFn('https://openrouter.ai/api/v1/chat/completions', {
    ...
    headers: {
      ...
      'X-Title': 'AIPhysicalTherapyMovementAnalyzer / gap-patients-without-patient',
    },
    body: JSON.stringify({
